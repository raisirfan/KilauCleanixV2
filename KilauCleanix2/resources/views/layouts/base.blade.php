...
<head>
    <meta charset="utf-8">
    <title>Kilau Cleanix - Online Service Provider for your House Needs</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="visible-md visible-lg text-left">
                            <li><a href="tel:+60123456789"><i class="fa fa-phone"></i> +60-1234567890</a></li>
                            <li><a href="mailto:contact@kilaucleanix.my"><i class="fa fa-envelope"></i>
                                    contact@kilaucleanix.my</a></li>
                        </ul>
                        ...
                        <ul class="contact_footer">
                            ...
                            <li>
                                <i class="fa fa-envelope"></i> <a
                                    href="mailto:contact@kilaucleanix.my">contact@kilaucleanix.my</a>
                            </li>
                            <li>
                                <i class="fa fa-headphones"></i> <a href="tel:+60123456789">+60-1234567890</a>
                            </li>
                        </ul>
                ...
                <div class="row visible-sm visible-xs">
                    <div class="col-md-6">
                        ...
                        <ul class="contact_footer mlist">
                            ...
                            <li>
                                <i class="fa fa-phone"></i> <a href="tel:+60123456789">+60-1234567890</a>
                            </li>
                        </ul>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2022 KilauCleanix Sdn Bhd. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>                
            </div>            
